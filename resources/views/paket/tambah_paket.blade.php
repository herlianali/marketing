...
<body>
    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
        ...
        <div class="card">
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('paket.store') }}" method="POST">
                @csrf
                ...
                <input type="text" class="form-control @error('fee_marketing') is-invalid @enderror" id="fee_marketing" name="fee_marketing" placeholder="Masukkan Fee Marketing" value="{{ old('fee_marketing') }}" required autocomplete="fee_marketing"/>
                @error('fee_marketing')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
